...
names with the C<logging_methods> function.

    Log::Any::Adapter::Util::ogging_methods
...
To help generate these methods programmatically, you can get a list of the sub
names with the C<detection_methods> function.
...
The following L<Log::Any::Adapter::Util> functions give you a list

=over

=item Log::Any::Adapter::Util::logging_methods

Returns a list of logging methods: debug, info, etc.

=item Log::Any::Adapter::Util::detection_methods

Returns a list of detection methods: is_debug, is_info, etc.

=item Log::Any::Adapter::Util::logging_and_detection_methods
